...
namespace Proto.Remote.GrpcCore
{
    ...
    {
        public static GrpcCoreRemoteConfig WithChannelOptions(this GrpcCoreRemoteConfig remoteConfig,
            IEnumerable<ChannelOption> options) =>
            remoteConfig with { ChannelOptions = options };

        public static GrpcCoreRemoteConfig WithChannelCredentials(this GrpcCoreRemoteConfig remoteConfig,
            ChannelCredentials channelCredentials) =>
            remoteConfig with { ChannelCredentials = channelCredentials };

        public static GrpcCoreRemoteConfig WithServerCredentials(this GrpcCoreRemoteConfig remoteConfig,
