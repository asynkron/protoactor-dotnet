...
namespace Proto.Persistence
{
    public class Persistence
    {
        ...
        public static Persistence WithSnapshotting(
            ISnapshotStore snapshotStore, string actorId, Action<Snapshot> applySnapshot
        )
        {
        ...
        /// </summary>
        public Task ReplayEvents(long fromIndex, long toIndex)
        {
            ...
            return _eventStore.GetEventsAsync(_actorId, fromIndex, toIndex, @event =>
            {
