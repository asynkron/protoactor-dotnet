...
public static class RemoteConfigExtensions
{
    ...
    /// </summary>
    /// <param name="remoteConfig"></param>
    /// <param name="serializerId">Serializer id. By default 0 is the protobuf serializer and 1 is the json serializer. Use other values for custom serializers.</param>
    /// <param name="priority">Priority defined in which order Serializers should be considered to be the serializer for a given type (highest value takes precedence). ProtoBufSerializer has priority of 0, and JsonSerializer has priority of -1000. </param>
