//-----------------------------------------------------------------------
// <copyright file="FlowOperations.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Dsl
{
    ...
    public static class FlowOperations
    {
        ...
        /// '''Cancels when''' downstream cancels
        /// </summary>
        public static Flow<T, T, TMat> Watch<T, TMat>(this Flow<T, T, TMat> flow, PID pid) =>
            (Flow<T, T, TMat>)InternalFlowOperations.Watch(flow, pid);
