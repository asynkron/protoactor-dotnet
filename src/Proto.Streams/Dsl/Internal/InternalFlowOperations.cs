//-----------------------------------------------------------------------
// <copyright file="InternalFlowOperations.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Dsl.Internal
{
    ...
    internal static class InternalFlowOperations
    {
        ...
        /// '''Cancels when''' downstream cancels
        /// </summary>
        public static IFlow<T, TMat> Watch<T, TMat>(this IFlow<T, TMat> flow, PID pid) => flow.Via(new Fusing.Watch<T>(pid));
