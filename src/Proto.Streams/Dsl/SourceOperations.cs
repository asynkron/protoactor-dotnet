//-----------------------------------------------------------------------
// <copyright file="SourceOperations.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Dsl
{
    ...
    public static class SourceOperations
    {
        ...
        /// '''Cancels when''' downstream cancels
        /// </summary>
        public static Source<T, TMat> Watch<T, TMat>(this Source<T, TMat> flow, PID pid) =>
            (Source<T, TMat>)InternalFlowOperations.Watch(flow, pid);
    }
}