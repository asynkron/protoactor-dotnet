//-----------------------------------------------------------------------
// <copyright file="Tcp.cs" company="Proto.NET Project">
...
using Proto.Streams.Implementation.IO;
...
namespace Proto.Streams.Dsl
{
    ...
    public class TcpExt : IExtension
    {
        ...
        /// <param name="options">TCP options for the connections, see <see cref="Tcp"/> for details</param>
