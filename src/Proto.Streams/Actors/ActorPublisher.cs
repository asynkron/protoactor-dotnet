//-----------------------------------------------------------------------
// <copyright file="ActorPublisher.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Actors
{
    ...
    public static class ActorPublisher
    {
        ...
        /// <returns>TBD</returns>
        public static IPublisher<T> Create<T>(PID @ref) => new ActorPublisherImpl<T>(@ref);
    }
    ...
    public sealed class ActorPublisherImpl<T> : IPublisher<T>
    {
        ...
        /// </exception>
        public ActorPublisherImpl(PID @ref)
        {
            if(@ref == null) throw new ArgumentNullException(nameof(@ref), "ActorPublisherImpl requires PID to be defined");
            _ref = @ref;
        }
    ...
    public sealed class ActorPublisherSubscription : ISubscription
    {
        ...
        /// This exception is thrown when the specified <paramref name="ref"/> is undefined.
        /// </exception>
        public ActorPublisherSubscription(PID @ref)
        {
            if (@ref == null) throw new ArgumentNullException(nameof(@ref), "ActorPublisherSubscription requires PID to be defined");
            _ref = @ref;
        }
    ...
    internal class ActorPublisherState : ExtensionIdProvider<ActorPublisherState>, IExtension
    {
        ...
        private readonly ConcurrentDictionary<PID, State> _state = new ConcurrentDictionary<PID, State>();
        ...
        /// <returns>TBD</returns>
        public State Get(PID pid)
        {
            _state.TryGetValue(pid, out var state);
            return state;
        }
        ...
        public void Set(PID pid, State s) => _state.AddOrUpdate(pid, s, (@ref, oldState) => s);
        ...
        /// <param name="pid">TBD</param>
        /// <returns>TBD</returns>
        public State Remove(PID pid)
        {
            State s;
            return _state.TryRemove(pid, out s) ? s : null;
        }
