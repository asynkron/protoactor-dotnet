//-----------------------------------------------------------------------
// <copyright file="ActorSubscriber.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Actors
{
    ...
    public abstract class ActorSubscriber : ActorBase
    {
        ...
        /// <returns>TBD</returns>
        public static ISubscriber<T> Create<T>(PID @ref) => new ActorSubscriberImpl<T>(@ref);
    }
    ...
    public sealed class ActorSubscriberImpl<T> : ISubscriber<T>
    {
        ...
        /// </exception>
        public ActorSubscriberImpl(PID impl)
        {
