//-----------------------------------------------------------------------
// <copyright file="IMaterializer.cs" company="Proto.NET Project">
...
namespace Proto.Streams
{
    ...
    /// is not yet final and may change in patch releases of Proto. Please note that this
    /// does not impact end-users of Proto streams, only implementors of custom materializers,
    /// with whom the Proto.Net team co-ordinates such changes.
    /// 
    ...
    public interface IMaterializer
    {
        ...
        /// </summary>
        IDispatcher ExecutionContext { get; }
    }
    ...
    public sealed class NoMaterializer : IMaterializer
    {
        ...
        /// </exception>
        public IDispatcher ExecutionContext
        {
