//-----------------------------------------------------------------------
// <copyright file="ActorMaterializer.cs" company="Proto.NET Project">
...
namespace Proto.Streams
{
    ...
    public abstract class ActorMaterializer : IMaterializer, IMaterializerLoggingProvider, IDisposable
    {
        ...
        /// pipeline within its own <see cref="ActorBase"/>. The required <see cref="PIDFactory"/>
        ...
        /// </exception>
        /// <returns>TBD</returns>
        public static ActorMaterializer Create(IInfoContext context, ActorMaterializerSettings settings = null, string namePrefix = null)
        {
        ...
        private static ActorSystem ActorSystemOf(IInfoContext context)
        {
        ...
        /// TBD
        /// </summary>
        public abstract IDispatcher ExecutionContext { get; }
        ...
        /// TBD
        /// </summary>
        public abstract PID Supervisor { get; }
        ...
        /// <returns>TBD</returns>
        public abstract PID ActorOf(MaterializationContext context, Props props);
    ...
    public class AbruptTerminationException : Exception
    {
        ...
        public AbruptTerminationException(PID actor)
        ...
        {
            Actor = (PID)info.GetValue("Actor", typeof(PID));
        }
    }
    ...
    public static class ActorMaterializerExtensions
    {
        ...
        /// <param name="namePrefix">TBD</param>
        /// <returns>TBD</returns>
        public static ActorMaterializer Materializer(this IInfoContext context, ActorMaterializerSettings settings = null, string namePrefix = null)
