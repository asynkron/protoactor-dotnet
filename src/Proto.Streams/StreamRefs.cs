...
namespace Proto.Streams
{
    ...
    public class IllegalStateException : Exception
    {
        ...
        public IllegalStateException(string message, StreamingContext context) : base(message)
        {
        ...
        public IllegalStateException(SerializationInfo serializationInfo, StreamingContext context) : base()
        {
    ...
    {
        public PID ExpectedRef { get; }
        public PID GotRef { get; }

        public InvalidPartnerActorException(PID expectedRef, PID gotRef, string message) : base(
