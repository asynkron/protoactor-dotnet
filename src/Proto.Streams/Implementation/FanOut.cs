//-----------------------------------------------------------------------
// <copyright file="FanOut.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation
{
    ...
    public class OutputBunch<T>
    {
        ...
        private sealed class FanoutOutputs : SimpleOutputs
        {
            ...
            public FanoutOutputs(int id, PID actor, IPump pump) : base(actor, pump)
            {
                _id = id;
            }
        ...
        public OutputBunch(int outputCount, PID impl, IPump pump)
        {
    ...
    public static class FanOut
    {
        ...
        /// </summary>
        [Serializable]
        public struct SubstreamRequestMore 
        {
            /// <summary>
            /// TBD
            /// </summary>
        ...
        /// </summary>
        [Serializable]
        public struct SubstreamSubscribePending 
        {
            /// <summary>
            /// TBD
            /// </summary>
        ...
        public class SubstreamSubscription : ISubscription
        {
            ...
            /// <param name="id">TBD</param>
            public SubstreamSubscription(PID parent, int id)
            {
                _parent = parent;
                _id = id;
            }
        ...
        /// <typeparam name="T">TBD</typeparam>
        [Serializable]
        public struct ExposedPublishers<T> 
        {
            /// <summary>
            /// TBD
            /// </summary>
