//-----------------------------------------------------------------------
// <copyright file="Sinks.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation
{
    ...
    public sealed class ActorSubscriberSink<TIn> : SinkModule<TIn, PID>
    {
        ...
        /// <param name="shape">TBD</param>
        /// <returns>TBD</returns>
        protected override SinkModule<TIn, PID> NewInstance(SinkShape<TIn> shape)
        ...
        /// <param name="materializer">TBD</param>
        /// <returns>TBD</returns>
        public override object Create(MaterializationContext context, out PID materializer)
        {
    ...
    public sealed class ActorRefSink<TIn> : SinkModule<TIn, NotUsed>
    {
        ...
        /// <param name="attributes">TBD</param>
        /// <param name="shape">TBD</param>
        public ActorRefSink(PID @ref, object onCompleteMessage, Attributes attributes, SinkShape<TIn> shape)
            : base(shape)
        {
            _ref = @ref;
