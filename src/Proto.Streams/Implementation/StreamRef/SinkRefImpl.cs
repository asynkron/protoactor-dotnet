//-----------------------------------------------------------------------
// <copyright file="SinkRefImpl.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation.StreamRef
{
    ...
    {
        public static SinkRefImpl Create(Type eventType, PID initialPartnerRef)
        {
        ...
        protected SinkRefImpl(PID initialPartnerRef)
        {
    ...
    {
        public SinkRefImpl(PID initialPartnerRef) : base(initialPartnerRef) { }
    ...
    internal sealed class SinkRefStageImpl<TIn> : GraphStageWithMaterializedValue<SinkShape<TIn>, Task<ISourceRef<TIn>>>
    {
        ...
        public SinkRefStageImpl(PID initialPartnerRef)
        {
