//-----------------------------------------------------------------------
// <copyright file="StreamRefsProtocol.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation.StreamRef
{
    ...
    /// </summary>
    internal sealed class SequencedOnNext : IStreamRefsProtocol
    {
    ...
    /// </summary>
    internal sealed class OnSubscribeHandshake : IStreamRefsProtocol
    {
        public OnSubscribeHandshake(PID targetRef)
        {
            TargetRef = targetRef;
        }

        public PID TargetRef { get; }
    }
    ...
    /// </summary>
    internal sealed class CumulativeDemand : IStreamRefsProtocol
    {
