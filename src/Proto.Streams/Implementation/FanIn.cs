//-----------------------------------------------------------------------
// <copyright file="FanIn.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation
{
    ...
    public abstract class FanIn<T> : ActorBase, IPump
    {
        ...
        public struct SubInput : ISubscriber<T>
        {
            ...
            /// <param name="id">TBD</param>
            public SubInput(PID impl, int id)
            {
                _impl = impl;
                _id = id;
            }
