//-----------------------------------------------------------------------
// <copyright file="ActorRefSinkActor.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation
{
    ...
    public class ActorRefSinkActor : ActorSubscriber
    {
        ...
        /// <returns>TBD</returns>
        public static Props Props(PID @ref, int highWatermark, object onCompleteMessage)
        ...
        /// <param name="highWatermark">TBD</param>
        /// <param name="onCompleteMessage">TBD</param>
        public ActorRefSinkActor(PID @ref, int highWatermark, object onCompleteMessage)
        {
            Ref = @ref;
