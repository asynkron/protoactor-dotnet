//-----------------------------------------------------------------------
// <copyright file="Modules.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation
{
    ...
    public sealed class ActorPublisherSource<TOut> : SourceModule<TOut, PID>
    {
        ...
        /// <param name="shape">TBD</param>
        /// <returns>TBD</returns>
        protected override SourceModule<TOut, PID> NewInstance(SourceShape<TOut> shape)
        ...
        /// <param name="materializer">TBD</param>
        /// <returns>TBD</returns>
        public override IPublisher<TOut> Create(MaterializationContext context, out PID materializer)
        {
    ...
    public sealed class ActorRefSource<TOut> : SourceModule<TOut, PID>
    {
