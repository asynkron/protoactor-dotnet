//-----------------------------------------------------------------------
// <copyright file="FanoutProcessorImpl.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation
{
    ...
    internal class FanoutOutputs<T, TStreamBuffer> : SubscriberManagement<T, TStreamBuffer>, IOutputs where TStreamBuffer : IStreamBuffer<T>
    {
        ...
        /// </exception>
        public FanoutOutputs(int maxBufferSize, int initialBufferSize, PID self, IPump pump, Action afterShutdown = null)
        {
            _self = self;
            _pump = pump;
