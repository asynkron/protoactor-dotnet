//-----------------------------------------------------------------------
// <copyright file="ActorProcessor.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation
{
    ...
    internal static class ActorProcessor
    {
        ...
        /// <returns>TBD</returns>
        public static ActorProcessor<TIn, TOut> Create<TIn, TOut>(PID impl)
        {
    ...
    internal class ActorProcessor<TIn, TOut> : ActorPublisher<TOut>, IProcessor<TIn, TOut>
    {
        ...
        /// </summary>
        /// <param name="impl">TBD</param>
        public ActorProcessor(PID impl) : base(impl)
        {
        }
    ...
    public class SimpleOutputs : IOutputs
    {
        ...
        /// <param name="pump">TBD</param>
        public SimpleOutputs(PID actor, IPump pump)
        {
            Actor = actor;
            Pump = pump;
