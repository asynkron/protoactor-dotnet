//-----------------------------------------------------------------------
// <copyright file="ActorGraphInterpreter.cs" company="Proto.NET Project">
...
namespace Proto.Streams.Implementation.Fusing
{
    ...
    public sealed class GraphInterpreterShell
    {
        ...
        /// <returns>TBD</returns>
        public int Init(PID self, SubFusingActorMaterializerImpl subMat, Action<object> enqueueToShourtCircuit, int eventLimit)
        {
            Self = self;
...
#pragma warning restore CS0162
    ...
    public class ActorGraphInterpreter : ActorBase
    {
        ...
        public sealed class BoundaryPublisher<T> : ActorPublisher<T>
        {
            ...
            /// <param name="shell">TBD</param>
            /// <param name="id">TBD</param>
            public BoundaryPublisher(PID parent, GraphInterpreterShell shell, int id) : base(parent)
            {
        ...
        public sealed class BoundarySubscription : ISubscription
        {
            ...
            /// <param name="shell">TBD</param>
            /// <param name="id">TBD</param>
            public BoundarySubscription(PID parent, GraphInterpreterShell shell, int id)
            {
                _parent = parent;
                _shell = shell;
                _id = id;
        ...
        public sealed class BoundarySubscriber<T> : ISubscriber<T>
        {
            ...
            /// <param name="shell">TBD</param>
            /// <param name="id">TBD</param>
            public BoundarySubscriber(PID parent, GraphInterpreterShell shell, int id)
            {
                _parent = parent;
                _shell = shell;
                _id = id;
        ...
        internal class ActorOutputBoundary<T> : DownstreamBoundaryStageLogic, IActorOutputBoundary
        {
            ...
            /// <param name="shell">TBD</param>
            /// <param name="id">TBD</param>
            public ActorOutputBoundary(PID actor, GraphInterpreterShell shell, int id)
            {
                _actor = actor;
                _shell = shell;
                _id = id;
...
#pragma warning restore CS0162
        ...
        /// <param name="shell">TBD</param>
        /// <returns>TBD</returns>
        public PID RegisterShell(GraphInterpreterShell shell)
        {
