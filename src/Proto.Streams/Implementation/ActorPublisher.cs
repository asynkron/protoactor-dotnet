...
namespace Proto.Streams.Implementation
{
    ...
    public class ActorPublisher<TOut> : IActorPublisher, IPublisher<TOut>
    {
        ...
        public ActorPublisher(PID impl)
        {
            Impl = impl;
        }
    ...
    public static class ActorSubscription
    {
        ...
        /// <param name="subscriber">TBD</param>
        /// <returns>TBD</returns>
        internal static IActorSubscription Create(PID implementor, IUntypedSubscriber subscriber)
        {
        ...
        /// <param name="subscriber">TBD</param>
        /// <returns>TBD</returns>
        public static IActorSubscription Create<T>(PID implementor, ISubscriber<T> subscriber)
    ...
    public class ActorSubscription<T> : IActorSubscription
    {
        ...
        /// TBD
        /// </summary>
        public readonly PID Implementor;
        /// <summary>
        /// TBD
        /// </summary>
        ...
        /// <param name="implementor">TBD</param>
        /// <param name="subscriber">TBD</param>
        public ActorSubscription(PID implementor, ISubscriber<T> subscriber)
        {
    ...
    public class ActorSubscriptionWithCursor<TIn> : ActorSubscription<TIn>, ISubscriptionWithCursor<TIn>
    {
        ...
        /// <param name="implementor">TBD</param>
        /// <param name="subscriber">TBD</param>
        public ActorSubscriptionWithCursor(PID implementor, ISubscriber<TIn> subscriber) : base(implementor, subscriber)
        {
            IsActive = true;
            TotalDemand = 0;
            Cursor = 0;
