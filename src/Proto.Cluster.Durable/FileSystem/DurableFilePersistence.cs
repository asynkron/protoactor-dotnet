...
namespace Proto.Cluster.Durable.FileSystem
{
        ...
        : IDurablePersistence
    {
        ...
        {
            if (responseMessage is not IMessage) throw new NotSupportedException("Message must be Protobuf message");
        ...
        {
            if (requestMessage is not IMessage) throw new NotSupportedException("Message must be Protobuf message");
