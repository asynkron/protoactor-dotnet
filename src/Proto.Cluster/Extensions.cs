...
namespace Proto.Cluster
{
    public static class Extensions
    {
        ...
        public static Cluster Cluster(this ActorSystem system) => system.Extensions.Get<ClusterExtension>()!.Cluster;

        public static Cluster Cluster(this IContext context) => context.System.Extensions.Get<ClusterExtension>()!.Cluster;
        ...
        {
            var cluster = context.System.Extensions.Get<ClusterExtension>()!.Cluster;
