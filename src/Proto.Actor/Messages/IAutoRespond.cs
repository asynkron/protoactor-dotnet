...
/// <summary>
/// A message implementing with IAutoRespond will not be passed to actor's Receive method, but instead an automatic response will be returned to the sender.
/// </summary>
