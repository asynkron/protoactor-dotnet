...
public static class PidExtensions
{
    ...
    public static bool TryTranslateToProxyPID(this PID pid, ActorSystem system, string proxyAddress,
        [NotNullWhen(true)] out PID? clientPid)
    {
    ...
    public static bool TryGetSystemId(this PID pid, ActorSystem system, [NotNullWhen(true)] out string? systemId)
    {
        ...
        if (pid.Address == system.Address && pid.IsClientId())
        {
