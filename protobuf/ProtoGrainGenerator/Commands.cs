...
namespace ProtoGrainGenerator
{
    public static class Commands
    {
        ...
        {
            var importPath = new Option<IEnumerable<DirectoryInfo>>("--importPath", () => new Empty(), "Path for additional imports")
                .ExistingOnly();
            ...
            rootCommand.Handler = CommandHandler.Create<FileInfo, FileInfo, IEnumerable<DirectoryInfo>>(Generator.GenerateOne);
            ...
            generateCommand.Handler = CommandHandler.Create<IEnumerable<FileInfo>, IEnumerable<DirectoryInfo>>(Generator.GenerateMany);
