...
public class ActorTests
{
    ...
    public async Task CanNotSpawnAfterShutdown()
    {
        ...
        var pid = context.SpawnActorFromFunc(ctx =>
            {
        ...
        var pid2 = context.SpawnActorFromFunc(ctx =>
            {
                if (ctx.Message is string)
                {
                    ctx.Respond("hey");
    ...
    public async Task RequestActorAsyncCanTouchActor()
    {
        ...
        //no code...
        var pid = context.SpawnActorFromFunc(ctx => Task.CompletedTask);
    ...
    public async Task RequestActorAsync_should_raise_TimeoutException_when_timeout_is_reached()
    {
        ...
        var pid = context.SpawnActorFromFunc(EmptyReceive);
    ...
    public async Task ForwardActorAsync()
    {
        ...
        var forwarder = context.SpawnForwarderFromFunc(ctx =>
            {
                if (ctx.Message is string)
                {
                    ctx.Forward(pid);
