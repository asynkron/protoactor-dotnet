...
namespace Proto.Persistence.Tests
{
    public class ExamplePersistentActorTests
    {
        ...
        private (PID pid, Props props, string actorId, IProviderState providerState) CreateTestActor()
        {
            ...
            var props = Actor.FromProducer(() => new ExamplePersistentActor(new Persistence(provider, actorId)))
    ...
    internal class ExamplePersistentActor : IActor
    {
        ...
        public ExamplePersistentActor(Persistence persistence)
        {
        ...
        private Task Save(object @event)
        {
            return _persistence.PersistEventAsync(@event, ApplyEvent);
        }
        ...
        public async Task ReceiveAsync(IContext context)
        {
            ...
            {
                case Started _:
                    await _persistence.RecoverStateFromSnapshotThenEventsAsync(ApplySnapshot, ApplyEvent);
                    break;
                case GetState _:
                ...
                case RequestSnapshot _:
                    ...
                    break;
                case Multiply msg:
                    // would do some business logic...
                    await Save(new Multiplied {Amount = msg.Amount});
                    break;
            }
        }
    }
