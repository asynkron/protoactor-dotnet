// -----------------------------------------------------------------------
// <copyright file = "PartitionActivatorTests.cs" company = "Asynkron AB">
...
public class PartitionActivatorTests
{
    private readonly ITestOutputHelper _output;

    public PartitionActivatorTests(ITestOutputHelper output) => _output = output;

    private long _requests = 0;

    [Theory]
    [InlineData(100, 5, 12, 20)]
    ...
    private static async Task<PartitionActivatorClusterFixture> InitClusterFixture(
        int memberCount)
    {
        var fixture = new PartitionActivatorClusterFixture(memberCount);
