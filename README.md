...
|                              | Name                                     | Role                                  |
| ---------------------------- | ---------------------------------------- | ------------------------------------- |
| ![](/.images/asynkron.png)   | [Asynkron AB](https://asynkron.se)       | Founder and owner of Proto.Actor      |
|                              | Helleborg AS                             | Core contributor team                 |
| ![](/.images/ubiquitous.png) | [Ubiquitous AS](https://ubiquitous.no/)  | Core contributor team                 |
| ![](/.images/ahoy.svg)       | [Ahoy Games](https://www.ahoygames.com/) | Core contributor team                 |
| ![](/.images/etteplan.png)   | [Etteplan](https://www.etteplan.com/)    | Contributing tutorials, documentation |
